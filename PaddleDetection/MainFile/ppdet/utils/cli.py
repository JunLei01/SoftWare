...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument("-c", "--config", default = 'D:/MultiTargetTracking/PaddleDetection/configs/cascade_rcnn/cascade_rcnn_r50_vd_fpn_ssld_2x_coco.yml', help="configuration file to use")
        self.add_argument(
